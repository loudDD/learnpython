...
# lis = ["a","a","b","a","b","c"]
# result = dict(zip(set(lis),[lis.count([i for i in set(lis)])]))
# print(result)
# print(dict(zip(set(lis),[1,2,3])))
# print([lis.count(i for i in str(set(lis)))])
# print("a",[i for i in list(set(lis))])
# print(lis.count("a"))
# # for i in lis:
# print(lis.count("a"))
#
# for i in [lis.count([i for i in set(lis)])]:
#     print(1,i)
# for i in [i for i in set(lis)]:
# #     print(2,i)
# lis = ["a","a","b","a","b","c"]
# dic = {}
# for i in set(lis):
